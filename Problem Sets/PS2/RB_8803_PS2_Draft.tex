...
\begin{enumerate}[(a)]
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=1\linewidth]{Economic Data Analysis//Problem Sets//PS2/t_1c.png}
    \end{figure}
    \item Generate (and report) a histogram of the birth weight variable. This is our outcome of interest.
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\linewidth]{Economic Data Analysis//Problem Sets//PS2/p_1d.png}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}[(a)]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item I would exclude the following covariates as bad controls impacted by smoking: dgestat, phyper, preterm, pre4000, anemia, cardiac, lung, diabetes, herpes, and chyper.
        \end{itemize}
    \end{itemize}
    For each category, explain your logic of classification \textbf{briefly}. Use your classification to decide on the list of covariates you'll keep for covariate adjustment for the rest of the problem set.
\end{enumerate}
...
\begin{enumerate}[(a)]
    ...
    \begin{itemize}
        \item The coefficient is 221 grams: the average baby born to non-smoking mothers weighs 221 grams more than babies born to smoking others with $p < 2 \times 10^{16}$.
        \item This will identify the average treatment effect when treatment is effectively randomly assigned when controlling for covariates.
    \end{itemize}
...
\end{longtable} 
    ...
    \begin{itemize}
        \item When interacting tobacco usage with diabetes status, the coefficient goes to 94.2g with $p = 0.087$. Smoking reduces birthweight less for diabetic mothers than non-diabetic mothers.
    \end{itemize}
